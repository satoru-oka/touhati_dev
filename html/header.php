...
<head>
  ...
  <link rel="shortcut icon" href="<?= get_template_directory_uri(); ?>/assets/images/common/favicon.ico" />
  ...
  <script type="text/javascript" src="<?= get_template_directory_uri(); ?>/assets/js/bundle.js"></script>
</head>
<body>
  <div class="container">
    <header id="header">
